...
ALTER TABLE SITE DROP COLUMN SERVER_PORT;
...
# Alter SITE_APP
ALTER TABLE SITE_APP DROP COLUMN URI_PATTERN;
ALTER TABLE SITE_APP DROP COLUMN DEFAULT_APP;
ALTER TABLE SITE_APP DROP COLUMN ENABLED;
...
ALTER TABLE ITEM CHANGE COLUMN AMOUNT_PER_MONTH AMOUNT DECIMAL(21,6) DEFAULT NULL;
...
ALTER TABLE ITEM_VALUE ADD COLUMN START_DATE DATETIME DEFAULT NULL;
ALTER TABLE ITEM_VALUE ADD INDEX START_DATE_IND USING BTREE(START_DATE);
ALTER TABLE ITEM_VALUE ADD COLUMN END_DATE DATETIME DEFAULT NULL;
ALTER TABLE ITEM_VALUE ADD INDEX END_DATE_IND USING BTREE(END_DATE);
