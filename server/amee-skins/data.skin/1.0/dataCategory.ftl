                ...
                <table>
                    ...
                    <#list dataCategories as dc>
                        <tr id='Elem_${dc.uid}'>
                            <td>${dc.name}</td>
                            <td>
                                <#if canViewEntity(dc)><a href='${basePath}${dc.fullPath}'><img
                                        src="/images/icons/folder_go.png" title="Go" alt="Go" border="0"/></a>
                                    <#if canDeleteEntity(dc)><input type="image"
                                                                    onClick="deleteDataCategory('${dc.uid}', '${basePath}${dc.fullPath}'); return false;"
                                                                    src="/images/icons/folder_delete.png" title="Delete"
                                                                    alt="Delete" border="0"/></#if>
                                </#if>
                                <#if allowPermissionEdit><input type="image"
                                                                onClick="openPermissionEditor('${dc.uid}'); return false;"
                                                                src="/images/icons/lock_edit.png"
                                                                title="Edit Permissions" alt="Edit Permissions"
                                                                border="0"/></#if>
                            </td>
                        </tr>
                    </#list>
                                                ...
                                                <tr id='Elem_${row.uid}'>
                                                    ...
                                                    <td>
                                                        <a href='${basePath}/${row.findCell(' path')}'><img
                                                            src="/images/icons/page_edit.png" title="Edit" alt="Edit"
                                                            border="0"/></a>
                                                        <#if canDelete()><input type="image"
                                                                                onClick="deleteDataItem('${row.uid}', '${basePath}/${row.uid}'); return false;"
                ...
                <form id="update" action='?method=put' method='POST' enctype='application/x-www-form-urlencoded'>
                    <table>
                            ...
                            <td colspan="2">
                                <select name='itemDefinitionUid'>
                                    ...
                                    <#list itemDefinitions as id>
                                        <option value='${id.uid}'
                                        <#if dataCategory.itemDefinition?? && dataCategory.itemDefinition.uid == id.uid>
                                            selected
                                        </#if>
                                        >${id.name}</option>
                                    </#list>
                        ...
                        <tr>
                            <td>Deprecated:</td>
                            <td colspan="2">
                                Yes <input type="radio" name="deprecated" value="true"
                                <#if dataCategory.deprecated> checked</#if>
                                />
                                No <input type="radio" name="deprecated" value="false"
                                <#if !dataCategory.deprecated> checked</#if>
                                />
                            </td>
                        </tr>
