...
@Component("definitionActionsResource")
@Scope("prototype")
public class DefinitionActionsResource extends BaseResource implements Serializable {
    ...
    public JSONObject getJSONObject() throws JSONException {
        ...
        obj.put("itemDefinition", itemDefinitionActions.getJSONObject());
        obj.put("itemValueDefinition", itemValueDefinitionActions.getJSONObject());
        obj.put("algorithm", algorithmActions.getJSONObject());
        return obj;
    }
