 ...
 */
public class ProfileCategoryCalendarRepresentation extends Representation {

    public ProfileCategoryCalendarRepresentation(ProfileCategoryResource resource) {
        super(resource);
    }
    ...
    private List<ProfileItem> getProfileItems(Profile profile, DataCategory dataCategory) {
        ...
        return resource.getProfileService().getProfileItems(profile, dataCategory, startDate, endDate);
    }
}
