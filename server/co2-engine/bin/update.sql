...
INSERT INTO amee.UNIT_DEFINITION (CREATED, MODIFIED, UID, ENVIRONMENT_ID, NAME, DESCRIPTION, UNITS, INTERNAL_UNIT) VALUES (CURDATE(), CURDATE(), 'AAAAAAAAAAAC', 1, 'kW', 'kW', 'kW', 'kW');
...
INSERT INTO amee.UNIT_DEFINITION (CREATED, MODIFIED, UID, ENVIRONMENT_ID, NAME, DESCRIPTION, UNITS, INTERNAL_UNIT) VALUES (CURDATE(), CURDATE(), uuid(), 1, 'energy', 'energy', 'kWh', 'kWh');
UPDATE item_value_definition SET unit_definition_id=48 WHERE id=105
