...
public class DataConstants {
    ...
    // Views
    public final static String VIEW_CARBON = "carbon.ftl";
    ...
    public final static String VIEW_ITEM_DEFINITION = "itemDefinition.ftl";
    public final static String VIEW_DRILL_DOWN = "drillDown.ftl";
    public final static String VIEW_ITEM_VALUE_DEFINITIONS = "itemValueDefinitions.ftl";
