...
public class ProfileFinder implements Serializable {
    ...
    private final static Logger log = Logger.getLogger(ProfileFinder.class);
    ...
    public List<ProfileItem> getProfileItems(String path) {
        ...
        if (profileItem != null) {
            ...
            if (dataCategory != null) {
                profileItems = profileService.getProfileItems(profileItem.getProfile(), dataCategory, profileItem.getValidFrom());
            }
        }
        return profileItems;
    }
