...
start transaction;
update PROFILE_ITEM set ID = ID + 6000000;
update PROFILE_ITEM_NUMBER_VALUE set PROFILE_ITEM_ID = PROFILE_ITEM_ID + 6000000;
update PROFILE_ITEM_TEXT_VALUE set PROFILE_ITEM_ID = PROFILE_ITEM_ID + 6000000;
commit;
