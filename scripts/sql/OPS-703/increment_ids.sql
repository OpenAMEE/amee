...
start transaction;
update PROFILE_ITEM set ID = ID + 5000000;
update PROFILE_ITEM_NUMBER_VALUE set PROFILE_ITEM_ID = PROFILE_ITEM_ID + 5000000;
update PROFILE_ITEM_TEXT_VALUE set PROFILE_ITEM_ID = PROFILE_ITEM_ID + 5000000;
commit;

-- Increment new item value tables
start transaction;
update PROFILE_ITEM_NUMBER_VALUE set ID = ID + 30000000;
update PROFILE_ITEM_TEXT_VALUE set ID = ID + 30000000;
commit;
...
insert into DATA_ITEM_NUMBER_VALUE_NEW (ID, UID, STATUS, VALUE, CREATED, MODIFIED, ITEM_VALUE_DEFINITION_ID, DATA_ITEM_ID, UNIT, PER_UNIT) 
	select ID + 30000000, UID, STATUS, VALUE, CREATED, MODIFIED, ITEM_VALUE_DEFINITION_ID, DATA_ITEM_ID, UNIT, PER_UNIT
...
insert into DATA_ITEM_TEXT_VALUE_NEW (ID, UID, STATUS, VALUE, CREATED, MODIFIED, ITEM_VALUE_DEFINITION_ID, DATA_ITEM_ID) 
	select ID + 30000000, UID, STATUS, VALUE, CREATED, MODIFIED, ITEM_VALUE_DEFINITION_ID, DATA_ITEM_ID
