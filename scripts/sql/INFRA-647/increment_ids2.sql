...
insert into PROFILE_ITEM_NEW (ID, UID, NAME, CREATED, MODIFIED, START_DATE, END_DATE, ITEM_DEFINITION_ID, DATA_ITEM_ID, PROFILE_ID, STATUS, DATA_CATEGORY_ID)
    ...
    from PROFILE_ITEM;
insert into PROFILE_ITEM_NUMBER_VALUE_NEW (ID + 40000000, UID, STATUS, VALUE, CREATED, MODIFIED, PROFILE_ITEM_ID, ITEM_VALUE_DEFINITION_ID, UNIT, PER_UNIT)
...
insert into PROFILE_ITEM_TEXT_VALUE_NEW (ID + 40000000, UID, STATUS, VALUE, CREATED, MODIFIED, PROFILE_ITEM_ID, ITEM_VALUE_DEFINITION_ID)
